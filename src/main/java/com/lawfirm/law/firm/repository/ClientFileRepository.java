...
public interface ClientFileRepository extends JpaRepository<ClientFile, UUID> {
    ...
    Page<ClientFile> findByClient_IdAndKindAndDeletedAtIsNull(
            UUID clientId, FileKind kind, Pageable pageable);
    ...
    Optional<ClientFile> findFirstByClient_IdAndKindAndDeletedAtIsNullOrderByUploadedAtDesc(
            UUID clientId, FileKind kind);
}
