...
/**
 * Aba "Dados profissionais": profissão, vínculos e credenciais previdenciárias.
 * contributionTime é texto livre (ex.: "3 anos, 10 meses, 22 dias") - o total
 * em meses é derivado no servidor (contributionInMonths, somente leitura).
 */
