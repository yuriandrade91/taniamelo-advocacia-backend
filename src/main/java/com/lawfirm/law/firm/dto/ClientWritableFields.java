...
/**
 * Contrato comum dos campos que a API pode escrever em um Client, compartilhado
 * entre ClientCreateRequestDTO (POST) e ClientUpdateRequestDTO (PUT). Mantém os
 * dois DTOs em sincronia sem herança e permite validação de unicidade única.
 */
